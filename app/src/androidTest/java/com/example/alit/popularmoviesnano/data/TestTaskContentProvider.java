...
package com.example.alit.popularmoviesnano.data;
...
import com.example.alit.popularmoviesnano.ContentProvider.MovieContentProvider;
import com.example.alit.popularmoviesnano.ContentProvider.MovieDbContract;
import com.example.alit.popularmoviesnano.ContentProvider.MovieDbHelper;
...
public class TestTaskContentProvider {
    ...
    public final String TAG = "movieUnitTest";
    ...
    private static final Uri TEST_MOVIES = MovieDbContract.MovieEntry.CONTENT_URI;
    // Content URI for a single task with id = 1
    private static final Uri TEST_MOVIES_WITH_MOVIE_ID = TEST_MOVIES.buildUpon().appendPath("1").build();
    ...
    public void testUriMatcher() {
        ...
        int actualTaskWithIdCode = testMatcher.match(TEST_MOVIES_WITH_MOVIE_ID);
        int expectedTaskWithIdCode = MovieContentProvider.MOVIES_WITH_MOVIE_ID;
    ...
    public void testInsert() {
        ...
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_MOVIE_ID, 1);
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_ORIGINAL_TITLE, "good title");
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_POSTER,
                DbUtils.getByteArray(ContextCompat.getDrawable(mContext, R.drawable.cloud_loading)));
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_OVERVIEW, "good movie");
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_VOTE_AVERAGE, 8.5);
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_RELEASE_DATE, "now");
        ...
        Uri uri = contentResolver.insert(MovieDbContract.MovieEntry.CONTENT_URI, testTaskValues);

        Uri expectedUri = ContentUris.withAppendedId(MovieDbContract.MovieEntry.CONTENT_URI, 1);
    ...
    public void testQuery() {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.cloud_loading);

        /* Create values to insert */
        ContentValues testTaskValues = new ContentValues();
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_MOVIE_ID, 2);
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_ORIGINAL_TITLE, "better title");
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_POSTER,
                DbUtils.getByteArray(ContextCompat.getDrawable(mContext, R.drawable.cloud_loading)));
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_OVERVIEW, "better movie");
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_VOTE_AVERAGE, 9.5);
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_RELEASE_DATE, "now");
        ...
        while (taskCursor.moveToNext()) {
            ...
            Log.d(TAG, "title: " + taskCursor.getString(taskCursor.getColumnIndex(MovieDbContract.MovieEntry.COLUMN_ORIGINAL_TITLE)));
    ...
    public void testDelete() {
        ...
        ContentValues testTaskValues = new ContentValues();
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_MOVIE_ID, 3);
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_ORIGINAL_TITLE, "best title");
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_POSTER,
                DbUtils.getByteArray(ContextCompat.getDrawable(mContext, R.drawable.cloud_loading)));
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_OVERVIEW, "best movie");
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_VOTE_AVERAGE, 10);
        testTaskValues.put(MovieDbContract.MovieEntry.COLUMN_RELEASE_DATE, "now");
        ...
        Uri uriToDelete = ContentUris.withAppendedId(MovieDbContract.MovieEntry.CONTENT_URI, 3);
